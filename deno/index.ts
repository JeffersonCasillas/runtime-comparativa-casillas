...
// Leer archivo CSV usando la API nativa de Deno
const contenidoCsv = await Deno.readTextFile('../data/estudiantes.csv');
...
// Escribir archivo de salida usando la API nativa de Deno
await Deno.writeTextFile('../output/resultado-deno.json', JSON.stringify(objetoSalida, null, 2));
